...
export default function EcommerceEdit() {
        ...
        <main className="mt-[10vh] w-[80vw] max-w-[1000px] m-auto flex flex-col lg:flex-row">            
          <form className="flex flex-col justify-center items-start gap-4">
            <div className="mt-[40px]">
              <Logo pageName={name} color={mainColor} icon={icon} lg={true} path={`/${name}/admin/edit`} />
            </div>
          ...
          <section className="mt-8 border rounded-xl overflow-hidden border-zinc-800 pb-4 lg:max-w-[500px]">
            <div className="bg-zinc-800 w-full p-1 text-center text-sm text-zinc-400">Exemplo</div>
            <header className="w-[80vw] max-w-[1000px] flex flex-col justify-between items-center bg-white z-10 dark:bg-black lg:w-full lg:max-w-[500px]">
                {
                  useTopHeader == true
                    ? (
                      <article className={`bg-${mainColor}-800 w-full h-[5vh] max-h-[35px] flex justify-center items-center text-white tracking-tight text-sm lg:max-w-[500px]`}>
                          <div className="flex justify-center items-center w-[80vw] px-2 sm:justify-between max-w-[1000px] lg:w-full lg:max-w-[500px]">
                ...
                <article className="w-full max-h-[80px] flex justify-center items-center bg-white dark:bg-zinc-900 lg:max-w-[500px]">
                    <div className="w-[80vw] h-[10vh] max-h-[80px] flex justify-between items-center max-w-[1000px] mr-[15px] px-2 lg:w-full lg:max-w-[450px]">
                        ...
                        <div className="flex gap-6 text-lg items-center w-[20vw] max-w-[200px] justify-end">
                          <nav className="font-antom flex items-center cursor-pointer w-[25px]">
                            <i className={`bi bi-cart-fill text-2xl transition hover:text-${mainColor}-500 dark:hover:text-${mainColor}-400`}></i>
            ...
            <article className="mt-[35px] w-[75vw] m-auto flex flex-col max-w-[1000px] px-1 lg:w-full lg:max-w-[450px] border">
              ...
              <div className="w-[74vw] max-w-[985px] h-full m-auto mt-[25px] flex justify-between cursor-pointer font-montserrat font-bold text-xs tracking-tight gap-2 overflow-hidden sm:text-[14px] lg:w-full lg:max-w-[450px]">
            ...
            <h1 className="w-[74vw] max-w-[985px] m-auto border mt-[10px] ml-3 font-bold font-antom tracking-tighter text-2xl lg:w-full lg:max-w-[450px]">Novos produtos</h1>
            ...
            <div className="m-auto w-[80vw] max-w-[1000px] mt-[40px] mb-[10px]">
              <button className={`${colorClasses[mainColor].bg} py-3 w-full rounded-xl transition hover:bg-black text-xl text-white`} type="button">
              Salvar alterações
              </button>
            </div>
          </section>

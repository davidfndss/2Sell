                ...
                atk 
                  ? (
                    <div className="flex gap-4 items-center">
                      ...
                      <nav className="transition cursor-pointer border border-red-500 text-red-500 rounded py-2 px-3 hover:border-red-400 hover:text-red-400 dark:border-zinc-500 dark:text-zinc-400 dark:hover:text-red-500 dark:border-zinc-600 dark:hover:border-red-500" onClick={() => router.push("logout") } title="sair">
